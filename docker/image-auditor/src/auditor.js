 ...
 */
var protocol = require('./protocol_udp');
...
s.on('message', function(msg, source) {
	...
	//juste verification à enlever

		var musicianActivesTab_= new Array();
	musicianActivesTab_.forEach((key,value) => {
		musicianActivesTab.push(value);
	});
	console.log("MAP VIEW :" + JSON.stringify(musicianActivesTab_));
